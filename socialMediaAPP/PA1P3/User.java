		...
		if (userSocket != null && output_stream != null && input_stream != null) {
			try {                
				...
				while (!closed) {
                    ...
                    PrintWriter datapw = new PrintWriter(output_stream);
                    BufferedWriter databw = new BufferedWriter(datapw);
		...
		try {
			...
			while ((responseLine = input_stream.readLine()) != null) {
				...
				if (responseLine.startsWith("#busy")){
                    ...
                    //System.out.println("New user joined as: " + responseLine.substring(9) + ", Welcome!\n");
